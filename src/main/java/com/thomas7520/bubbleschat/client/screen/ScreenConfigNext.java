...
public class ScreenConfigNext extends Screen {
    ...
    public void render(int mouseX, int mouseY, float p_render_3_) {
        ...
        drawString(font, maxBubblesText, guiLeft - font.getStringWidth(maxBubblesText) / 2, guiTop / 2 + 85, Color.WHITE.getRGB());

        String lengthLineMax = I18n.format("text.config.maxlinewidth");
        drawString(font, lengthLineMax, guiLeft - font.getStringWidth(lengthLineMax) / 2, guiTop / 2 + 125, Color.WHITE.getRGB());
