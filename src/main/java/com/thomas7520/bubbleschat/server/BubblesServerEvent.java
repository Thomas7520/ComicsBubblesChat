...
public class BubblesServerEvent {
    ...
    @SubscribeEvent
    public static void onSeverChatEvent(ServerChatEvent.Submitted event) {
    ...
    public static void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ComicsBubblesChat.channel.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getEntity())
